...
graph TB
    ...
    UI1 -->|"HTTP REST API"| AuthAPI
    UI2 -->|"HTTP REST API"| UsersAPI
    UI3 -->|"HTTP REST API"| DataSourcesAPI
    UI4 -->|"HTTP REST API"| TextToSQLAPI

    AuthAPI --> Service_Layer
    UsersAPI --> Service_Layer
    DataSourcesAPI --> Service_Layer
    ...
    classDef frontend fill:#e1f5fe,stroke:#01579b,font-color:#01579b
    classDef backend fill:#f3e5f5,stroke:#4a148c,font-color:#4a148c
    classDef storage fill:#e8f5e9,stroke:#1b5e20,font-color:#1b5e20
    classDef external fill:#fff3e0,stroke:#e65100,font-color:#e65100
